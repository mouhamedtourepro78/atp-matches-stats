...
The application can be accessed through: https://atp-matches-stats.herokuapp.com/ (Login : admin / Password : admin)
...
```
java -Dspring.profiles.active=production -jar ./target/atp-matches-stats-0.0.1-SNAPSHOT.jar
```
